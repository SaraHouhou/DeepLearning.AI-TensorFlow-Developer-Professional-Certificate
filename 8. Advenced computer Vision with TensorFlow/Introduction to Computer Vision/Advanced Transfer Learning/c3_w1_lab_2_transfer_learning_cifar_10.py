...
#Vous n'avez pas à vous soucier des détails internes de preprocess_input. 
# Mais idéalement, vous devriez charger les images avec les fonctions keras pour cela (vous garantissez ainsi que les images que vous chargez sont compatibles avec preprocess_input). 
